    ...
    while x == True:
        ...
        for event in pygame.event.get():                 # event loop : looks for events 
            ...
            if event.type == pygame.KEYDOWN:                        # takes user input to move heli
                ...
                if event.key == pygame.K_SPACE and game_active == 1:    # and start_game == True:
                    heli_movement = 0
                    heli_movement -= 4                                          # heli move up, HELI SPEED  
                    move_sound.play()                                           # heli sound
                if event.key == pygame.K_SPACE and game_active == 0:    # and start_game == False:       # To end and restart
                    game_active = 1  
                    #start_game = True
